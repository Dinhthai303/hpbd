const contentLetterSrart_actived = "Helluuuu chị Lam, đây là món quà em định gửi đến chị nè !!!" //Lời mở đầu cho bức thư
const mainContentLetter = "Chúc chị sinh nhật vui vẻ, ngày càng xinh đẹp và trưởng thành hơn, hạnh phúc hơn... Mọi điều tốt đẹp chị nhé♥!!!." //Nội dung của bức thư
...
imgLetter.src = "./img/8.jpg"; //Hình ảnh xuất hiện trong nội dung của bức thư sau khi bức thư được viết ra hết
